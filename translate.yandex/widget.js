(function (win, doc, nav, params, namespace, undefined) {
    ...
    var initWidget = function () {
        util.loadScript('https://yastatic.net/s3/translate/v20.9.4/js/tr_page.js', wrapper, function () {
                ...
                function (responseText) {
                    ...
                    new Widget({
                        ...
                        translator: new namespace.PageTranslator({
                            srv: 'tr-url-widget',
                            sid: '24bd2acd.5f7206c8.f7b58b3c.74722d75726c2d776964676574',
...
})(this, this.document, this.navigator, {"pageLang":"en","widgetTheme":"light","widgetId":"ytWidget","autoMode":"true"}, this.yt = this.yt || {});
