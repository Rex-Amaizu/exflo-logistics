    ...
    to {opacity: 1;}
            ...
            <div class="modal-body">
                ...
                <form action=registered.php method=post enctype="multipart/form-data">
                    ...
                    <input size=25 name="CPhone" placeholder="Client phone(no +) e.g 2348037691107"><br>
...
@-webkit-keyframes mymove {
    ...
    to {opacity: 1;}
                    ...
                    <font size=3 class="blinking"color=#34633e><b></b>FIRSTBIRD LOGISTICS EXPIRES June28th 2021.</b></font><br><br>
...
<!-- footer -->
			<div class="copy-right">
			    <div align=center>
				<p>&copy; <?php echo date('Y');?> EBUKA@MEETTHEGHOST. All rights reserved |  <a href="">+2348037691107</a></p>
