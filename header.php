...
?> 
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <a href="https://exflologistics.com/"><img src="images/logosite.png" alt="" width="250" height="100"></a>
   ...
   <li><div class="col-xs-6" style="padding-top: 20px; float: right !important; text-align: right;">
<!--<style type="text/css">
                        #yt-widget {
                            z-index: 99999;
                        }
