...
if(isset($_POST['firstname'])){
    ...
    $to      = 'info@firstbirdlogistics.com';
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4"><a href="#">+442033896071</a></p>
              <p class="mb-4"><a href="#">+61480048122</a></p>
              <p class="mb-4"><a href="#">+18724443099</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">info@firstbirdlogistics.com</a></p>
