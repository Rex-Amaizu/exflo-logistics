      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade">
            ...
            <p>Firstbird Logistics has been in operation for decades.</p>
            <p class="mb-5">we have recieved numerous acknowledgements from regulatory bodies and the public at large!</p>
            ...
            <div class="row">
              <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                <div class="unit-4">
                  ...
                  <div>
                    <h3>Firstbird Logistics</h3>
                    <p>One of our unique strategies is bringing your package to your comfort zone.</p>
              ...
              <div class="col-md-12 mb-md-5 mb-0 col-lg-6">
                <div class="unit-4">
                  ...
                  <div>
                    <h3>Fast</h3>
                    <p>Inexpres has the right equipment to make delivery process go just fast.</p>
                    <!--<p class="mb-0"><a href="#">Learn More</a></p>-->
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                ...
                <p class="mb-5">Select how you wish to pay for the service.</p>
                <ul class="ul-check list-unstyled white">
                  <li class="text-white">Before delivery</li>
                  <li class="text-white">As package goes</li>
                  <li class="text-white">On delivery</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                ...
                <p class="mb-5">For every package we assign a tracking ID whick can be used to track your package on our website.</p>
                <ul class="ul-check list-unstyled white">
                  <li class="text-white">track your package online</li>
...
<tr>
        <td width="120" class="auto-style1"><font color=red>Held at ' .$address2. ' contact us through info@firstbirdlogistics.com</font>';
...
<tr>
  ...
  <a class="btn btn-default" href="https://firstbirdlogistics.com">Back</a>
        </div>
      </div>
      </div>
      </div>
