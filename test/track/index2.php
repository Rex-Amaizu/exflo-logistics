...
<html lang="en">
  <head>
    <title>Door to Door Logitics</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light mb-5 text-uppercase font-weight-bold">Door to Door Logistics</h1>
      ...
      <div class="row align-items-center no-gutters align-items-stretch overlap-section">
        <div class="col-md-4">
          <div class="feature-1 pricing h-100 text-center">
            ...
            <p>Door To Door logistics is well known for it's mark in the courier services as a leading Logistics company that delivers to any point in the Universe. .</p>
          </div>
        </div>
        <div class="col-md-4">
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            ...
            <p class="color-black-opacity-5">Door To Door simply delivers.</p>
          </div>
        </div>
        ...
        <div>
          <a href="#" class="unit-1 text-center">
            ...
            <div class="unit-1-text">
              ...
              <p class="px-5">Door To Door has a state of the art storage facility for all kind of package.</p>
            </div>
          </a>
        </div>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="unit-4 d-flex">
              ...
              <div>
                <h3>Storage</h3>
                <p>Door To Door logistics offers storage services for goods that need preservations.</p>
                <!--<p><a href="#">Learn More</a></p>-->
              </div>
            </div>
          </div>
        ...
        <div class="slide-one-item home-slider owl-carousel">
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <p>&ldquo;I have been using Door To Door Logistics and they always always put smiles on my face.&rdquo;</p>
              </blockquote>
            </div>
          </div>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <p>&ldquo;All i can say is that Door To Door is really amazing, infact I switched from DHL and relied on Door To Door.&rdquo;</p>
              </blockquote>
            </div>
          </div>
          ...
          <div>
            <div class="testimonial">
              ...
              <blockquote>
                <p>&ldquo;Door To Door has been delivering my goods for years and i always rely on them.&rdquo;</p>
              </blockquote>
            </div>
          </div>
        ...
        <div class="row mb-3 align-items-stretch">
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
              ...
              <p>Door To Door has launched more way house facility in other to accomodate the number of goods at hand.</p>
            </div> 
          </div>
          <div class="col-md-6 col-lg-6 mb-4 mb-lg-4">
            <div class="h-entry">
